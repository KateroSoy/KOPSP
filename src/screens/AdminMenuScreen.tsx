...
import { CreditCard, History, Megaphone, Settings, LogOut, ChevronRight, User, BarChart3, Wallet } from 'lucide-react';
...
export const AdminMenuScreen: React.FC<AdminMenuScreenProps> = ({ onNavigate, onLogout }) => {
  ...
  const menuItems = [
    ...
    { id: 'admin_simpanan', label: 'Manajemen Simpanan', icon: Wallet, color: 'text-emerald-600', bg: 'bg-emerald-50' },
