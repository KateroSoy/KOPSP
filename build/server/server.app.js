...
export const createApp = (services = createServices()) => {
    ...
    app.get("/api/member/dashboard", requireAuth, requireRole("member"), asyncHandler(async (req, res) => {
        ok(res, await services.member.getDashboard(req.auth.userId));
    }));
    app.post("/api/member/loan-applications", requireAuth, requireRole("member"), asyncHandler(async (req, res) => {
    ...
    app.get("/api/admin/dashboard", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
        ok(res, await services.admin.getDashboard(req.auth.userId));
    }));
    app.get("/api/admin/bundle", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
        const userId = req.auth.userId;
        const [dashboard, members, savingsProducts, loanProducts, announcements, loans] = await Promise.all([
    ...
    app.get("/api/admin/reports/summary", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
    ...
    app.get("/api/admin/reports/members", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
    ...
    app.get("/api/admin/reports/savings", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
    ...
    app.get("/api/admin/reports/loans", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
    ...
    app.get("/api/admin/reports/installments", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
    ...
    app.get("/api/admin/reports/arrears", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
    ...
    app.get("/api/admin/reports/cashflow", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
    ...
    app.get("/api/admin/reports/daily-transactions", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
    ...
    app.get("/api/admin/reports/monthly-recap", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
    ...
    app.get("/api/admin/reports/member-detail/:id", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
    ...
    app.get("/api/admin/members", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
        ok(res, await services.admin.listMembers(req.auth.userId));
    }));
    app.post("/api/admin/members", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
        const body = parseWithSchema(memberCreateSchema, req.body);
        ok(res, await services.admin.createMember(req.auth.userId, {
            ...body,
            status: body.status ?? "Aktif",
        }), 201);
    }));
    app.put("/api/admin/members/:id", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
        const params = parseWithSchema(idParamSchema, req.params);
        const body = parseWithSchema(memberUpdateSchema, req.body);
        ok(res, await services.admin.updateMember(req.auth.userId, params.id, {
            ...body,
            status: body.status ?? "Aktif",
        }));
    }));
    app.delete("/api/admin/members/:id", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
        const params = parseWithSchema(idParamSchema, req.params);
        await services.admin.deleteMember(req.auth.userId, params.id);
        ok(res, { deleted: true });
    }));
    app.get("/api/admin/savings-products", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
        ok(res, await services.admin.listSavingsProducts(req.auth.userId));
    }));
    app.post("/api/admin/savings-products", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
    ...
    app.put("/api/admin/savings-products/:id", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
        const params = parseWithSchema(idParamSchema, req.params);
        const body = parseWithSchema(savingsProductSchema, req.body);
        ok(res, await services.admin.updateSavingsProduct(req.auth.userId, params.id, body));
    }));
    app.delete("/api/admin/savings-products/:id", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
        const params = parseWithSchema(idParamSchema, req.params);
        await services.admin.deleteSavingsProduct(req.auth.userId, params.id);
        ok(res, { deleted: true });
    }));
    app.get("/api/admin/loan-products", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
        ok(res, await services.admin.listLoanProducts(req.auth.userId));
    }));
    app.post("/api/admin/loan-products", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
        const body = parseWithSchema(loanProductSchema, req.body);
        ok(res, await services.admin.createLoanProduct(req.auth.userId, {
            ...body,
            adminFeeRate: body.adminFeeRate ?? 1,
        }), 201);
    }));
    app.put("/api/admin/loan-products/:id", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
        const params = parseWithSchema(idParamSchema, req.params);
        const body = parseWithSchema(loanProductSchema, req.body);
        ok(res, await services.admin.updateLoanProduct(req.auth.userId, params.id, {
            ...body,
            adminFeeRate: body.adminFeeRate ?? 1,
        }));
    }));
    app.delete("/api/admin/loan-products/:id", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
        const params = parseWithSchema(idParamSchema, req.params);
        await services.admin.deleteLoanProduct(req.auth.userId, params.id);
        ok(res, { deleted: true });
    }));
    app.get("/api/admin/announcements", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
        ok(res, await services.admin.listAnnouncements(req.auth.userId));
    }));
    app.post("/api/admin/announcements", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
    ...
    app.put("/api/admin/announcements/:id", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
        const params = parseWithSchema(idParamSchema, req.params);
        const body = parseWithSchema(announcementSchema, req.body);
        ok(res, await services.admin.updateAnnouncement(req.auth.userId, params.id, body));
    }));
    app.delete("/api/admin/announcements/:id", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
        const params = parseWithSchema(idParamSchema, req.params);
        await services.admin.deleteAnnouncement(req.auth.userId, params.id);
        ok(res, { deleted: true });
    }));
    app.get("/api/admin/loan-applications", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
        ok(res, await services.admin.listLoanApplications(req.auth.userId));
    }));
    app.patch("/api/admin/loan-applications/:id/status", requireAuth, requireRole("admin"), asyncHandler(async (req, res) => {
        const params = parseWithSchema(idParamSchema, req.params);
