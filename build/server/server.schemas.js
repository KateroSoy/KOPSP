import { z } from "zod";
const textField = (label, min, max) => z
    .string({
...
const optionalTextField = (label, max) => z
    .union([
    z
        .string({
        invalid_type_error: `${label} wajib berupa teks.`,
...
const passwordField = (label, min) => z
    .string({
    required_error: `${label} wajib diisi.`,
    invalid_type_error: `${label} wajib berupa teks.`,
})
...
const moneyField = (label) => z.coerce.number({
    required_error: `${label} wajib diisi.`,
